...
func Get(baseURL string, url string, setter ...func(*http.Request)) (body []byte, header http.Header, statusCode int) {
	return req(baseURL, `GET`, url, nil, setter...)
}

func Post(baseURL string, url string, data url.Values, setter ...func(*http.Request)) (body []byte, header http.Header, statusCode int) {
...
func PostJsonWithHeader(head map[string]string, baseURL string, url string, data []byte, setter ...func(*http.Request)) (body []byte, header http.Header, statusCode int) {
